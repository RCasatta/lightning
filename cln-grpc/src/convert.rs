...
#[allow(unused_variables)]
impl From<responses::ListtransactionsTransactionsInputs>
    for pb::ListtransactionsTransactionsInputs
{
...
#[allow(unused_variables)]
impl From<responses::ListtransactionsTransactionsOutputs>
    for pb::ListtransactionsTransactionsOutputs
{
...
impl From<requests::SendonionRequest> for pb::SendonionRequest {
    fn from(c: requests::SendonionRequest) -> Self {
        Self {
            ...
            shared_secrets: c
                .shared_secrets
                .map(|arr| arr.into_iter().map(|i| i.to_vec()).collect())
                .unwrap_or(vec![]), // Rule #3
            partid: c.partid.map(|v| v.into()),    // Rule #2 for type u16?
            bolt11: c.bolt11,                      // Rule #2 for type string?
            amount_msat: c.amount_msat.map(|f| f.into()), // Rule #2 for type msat?
...
impl From<pb::ListchannelsRequest> for requests::ListchannelsRequest {
    fn from(c: pb::ListchannelsRequest) -> Self {
        Self {
            short_channel_id: c
                .short_channel_id
                .map(|v| cln_rpc::primitives::ShortChannelId::from_str(&v).unwrap()), // Rule #1 for type short_channel_id?
...
impl From<pb::ListpeersPeersChannels> for responses::ListpeersPeersChannels {
    fn from(c: pb::ListpeersPeersChannels) -> Self {
        Self {
            ...
            alias: c.alias.map(|v| v.into()),
            state_changes: None,
            status: Some(c.status.into_iter().map(|s| s.into()).collect()), // Rule #4 string
...
impl From<pb::ListchannelsChannels> for responses::ListchannelsChannels {
    fn from(c: pb::ListchannelsChannels) -> Self {
        Self {
            ...
            destination: PublicKey::from_slice(&c.destination).unwrap(), // Rule #1 for type pubkey
            short_channel_id: cln_rpc::primitives::ShortChannelId::from_str(&c.short_channel_id)
                .unwrap(), // Rule #1 for type short_channel_id
...
impl From<pb::ConnectResponse> for responses::ConnectResponse {
    fn from(c: pb::ConnectResponse) -> Self {
        Self {
            ...
            features: hex::encode(&c.features),        // Rule #1 for type hex
            direction: c.direction.try_into().unwrap(),
            address: responses::ConnectAddress {
                // TODO fixed value for testing, should be  `address: c.address.unwrap().into(),`
                item_type: responses::ConnectAddressType::LOCAL_SOCKET,
                socket: None,
                address: None,
                port: None,
            },
...
#[allow(unused_variables)]
impl From<pb::ListtransactionsTransactionsInputs>
    for responses::ListtransactionsTransactionsInputs
{
...
#[allow(unused_variables)]
impl From<pb::ListtransactionsTransactionsOutputs>
    for responses::ListtransactionsTransactionsOutputs
{
