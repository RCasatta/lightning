...
pub mod requests {
	...
	pub struct SendpayRequest {
	    ...
	    #[serde(rename = "amount_msat", skip_serializing_if = "Option::is_none")]
	    ...
	    #[serde(rename = "localinvreqid", skip_serializing_if = "Option::is_none")]
	...
	pub struct AutocleaninvoiceRequest {
	    #[serde(rename = "expired_by", skip_serializing_if = "Option::is_none")]
	    pub expired_by: Option<u64>,
	    #[serde(rename = "cycle_seconds", skip_serializing_if = "Option::is_none")]
	...
	pub struct CloseRequest {
	    ...
	    #[serde(rename = "fee_negotiation_step", skip_serializing_if = "Option::is_none")]
	    pub fee_negotiation_step: Option<String>,
	    #[serde(rename = "wrong_funding", skip_serializing_if = "Option::is_none")]
	    pub wrong_funding: Option<Outpoint>,
	    #[serde(rename = "force_lease_closed", skip_serializing_if = "Option::is_none")]
	    pub force_lease_closed: Option<bool>,
	    #[serde(rename = "feerange", skip_serializing_if = "crate::is_none_or_empty")]
	...
	pub struct DelexpiredinvoiceRequest {
	    #[serde(rename = "maxexpirytime", skip_serializing_if = "Option::is_none")]
	...
	pub struct DelinvoiceRequest {
	    ...
	    #[serde(rename = "desconly", skip_serializing_if = "Option::is_none")]
	...
	pub struct InvoiceRequest {
	    ...
	    #[serde(rename = "fallbacks", skip_serializing_if = "crate::is_none_or_empty")]
	    pub fallbacks: Option<Vec<String>>,
	    #[serde(rename = "preimage", skip_serializing_if = "Option::is_none")]
	    pub preimage: Option<String>,
	    #[serde(rename = "exposeprivatechannels", skip_serializing_if = "Option::is_none")]
	    pub exposeprivatechannels: Option<bool>,
	    #[serde(rename = "cltv", skip_serializing_if = "Option::is_none")]
	    pub cltv: Option<u32>,
	    #[serde(rename = "deschashonly", skip_serializing_if = "Option::is_none")]
	...
	pub struct ListdatastoreRequest {
	    #[serde(rename = "key", skip_serializing_if = "crate::is_none_or_empty")]
	...
	pub struct ListinvoicesRequest {
	    #[serde(rename = "label", skip_serializing_if = "Option::is_none")]
	    pub label: Option<String>,
	    #[serde(rename = "invstring", skip_serializing_if = "Option::is_none")]
	...
	pub struct SendonionRequest {
	    #[serde(rename = "onion")]
	    pub onion: String,
	    #[serde(rename = "first_hop")]
	    pub first_hop: SendonionFirst_hop,
	    #[serde(rename = "payment_hash")]
	    pub payment_hash: Sha256,
	    #[serde(rename = "label", skip_serializing_if = "Option::is_none")]
	    pub label: Option<String>,
	    #[serde(rename = "shared_secrets", skip_serializing_if = "crate::is_none_or_empty")]
	...
	pub struct PayRequest {
	    ...
	    #[serde(rename = "label", skip_serializing_if = "Option::is_none")]
	    pub label: Option<String>,
	    #[serde(rename = "riskfactor", skip_serializing_if = "Option::is_none")]
	    pub riskfactor: Option<f64>,
	    #[serde(rename = "maxfeepercent", skip_serializing_if = "Option::is_none")]
	    pub maxfeepercent: Option<f64>,
	    #[serde(rename = "retry_for", skip_serializing_if = "Option::is_none")]
	    pub retry_for: Option<u16>,
	    #[serde(rename = "maxdelay", skip_serializing_if = "Option::is_none")]
	    pub maxdelay: Option<u16>,
	    #[serde(rename = "exemptfee", skip_serializing_if = "Option::is_none")]
	    pub exemptfee: Option<Amount>,
	    #[serde(rename = "localinvreqid", skip_serializing_if = "Option::is_none")]
	    pub localinvreqid: Option<String>,
	    #[serde(rename = "exclude", skip_serializing_if = "crate::is_none_or_empty")]
	...
	pub struct WaitanyinvoiceRequest {
	    #[serde(rename = "lastpay_index", skip_serializing_if = "Option::is_none")]
	...
	pub struct WithdrawRequest {
	    ...
	    #[serde(rename = "utxos", skip_serializing_if = "crate::is_none_or_empty")]
	...
	pub struct KeysendRequest {
	    ...
	    #[serde(rename = "exemptfee", skip_serializing_if = "Option::is_none")]
	    pub exemptfee: Option<Amount>,
	    #[serde(rename = "routehints", skip_serializing_if = "Option::is_none")]
	    pub routehints: Option<RoutehintList>,
	    #[serde(rename = "extratlvs", skip_serializing_if = "Option::is_none")]
	...
	pub struct FundpsbtRequest {
	    ...
	    #[serde(rename = "min_witness_weight", skip_serializing_if = "Option::is_none")]
	    pub min_witness_weight: Option<u32>,
	    #[serde(rename = "excess_as_change", skip_serializing_if = "Option::is_none")]
	...
	pub struct SignpsbtRequest {
	    #[serde(rename = "psbt")]
	    pub psbt: String,
	    #[serde(rename = "signonly", skip_serializing_if = "crate::is_none_or_empty")]
	...
	pub struct UtxopsbtRequest {
	    ...
	    #[serde(rename = "reserve", skip_serializing_if = "Option::is_none")]
	    pub reserve: Option<u32>,
	    #[serde(rename = "reservedok", skip_serializing_if = "Option::is_none")]
	...
	pub struct FundchannelRequest {
	    ...
	    #[serde(rename = "close_to", skip_serializing_if = "Option::is_none")]
	    pub close_to: Option<String>,
	    #[serde(rename = "request_amt", skip_serializing_if = "Option::is_none")]
	    pub request_amt: Option<Amount>,
	    #[serde(rename = "compact_lease", skip_serializing_if = "Option::is_none")]
	...
	pub struct GetrouteRequest {
	    ...
	    #[serde(rename = "fuzzpercent", skip_serializing_if = "Option::is_none")]
	    pub fuzzpercent: Option<u32>,
	    #[serde(rename = "exclude", skip_serializing_if = "crate::is_none_or_empty")]
	    pub exclude: Option<Vec<String>>,
	    #[serde(rename = "maxhops", skip_serializing_if = "Option::is_none")]
	...
	pub struct ListforwardsRequest {
	    ...
	    #[serde(rename = "out_channel", skip_serializing_if = "Option::is_none")]
	...
	pub struct PingRequest {
	    ...
	    pub len: Option<u16>,
	    #[serde(rename = "pongbytes", skip_serializing_if = "Option::is_none")]
	...
	pub struct SetchannelRequest {
	    #[serde(rename = "id")]
	    pub id: String,
	    #[serde(rename = "feebase", skip_serializing_if = "Option::is_none")]
	    pub feebase: Option<Amount>,
	    #[serde(rename = "feeppm", skip_serializing_if = "Option::is_none")]
	    pub feeppm: Option<u32>,
	    #[serde(rename = "htlcmin", skip_serializing_if = "Option::is_none")]
	    pub htlcmin: Option<Amount>,
	    #[serde(rename = "htlcmax", skip_serializing_if = "Option::is_none")]
	    pub htlcmax: Option<Amount>,
	    #[serde(rename = "enforcedelay", skip_serializing_if = "Option::is_none")]
...
pub mod responses {
	...
	pub struct GetinfoResponse {
	    ...
	    pub num_peers: u32,
	    #[serde(rename = "num_pending_channels")]
	    pub num_pending_channels: u32,
	    #[serde(rename = "num_active_channels")]
	    pub num_active_channels: u32,
	    #[serde(rename = "num_inactive_channels")]
	    pub num_inactive_channels: u32,
	    #[serde(rename = "version")]
	    pub version: String,
	    #[serde(rename = "lightning-dir")]
	    pub lightning_dir: String,
	    #[serde(rename = "our_features", skip_serializing_if = "Option::is_none")]
	    ...
	    pub network: String,
	    #[deprecated]
	    #[serde(rename = "msatoshi_fees_collected", skip_serializing_if = "Option::is_none")]
	    pub msatoshi_fees_collected: Option<u64>,
	    #[serde(rename = "fees_collected_msat")]
	    pub fees_collected_msat: Amount,
	    #[serde(rename = "address")]
	    pub address: Vec<GetinfoAddress>,
	    #[serde(rename = "binding", skip_serializing_if = "crate::is_none_or_empty")]
	    pub binding: Option<Vec<GetinfoBinding>>,
	    #[serde(rename = "warning_bitcoind_sync", skip_serializing_if = "Option::is_none")]
	    pub warning_bitcoind_sync: Option<String>,
	    #[serde(rename = "warning_lightningd_sync", skip_serializing_if = "Option::is_none")]
	...
	pub struct ListpeersPeersLog {
	    ...
	    #[serde(rename = "num_skipped", skip_serializing_if = "Option::is_none")]
	...
	pub struct ListpeersPeersChannelsInflight {
	    ...
	    #[serde(rename = "funding_outnum")]
	    pub funding_outnum: u32,
	    #[serde(rename = "feerate")]
	    pub feerate: String,
	    #[serde(rename = "total_funding_msat")]
	    pub total_funding_msat: Amount,
	    #[serde(rename = "our_funding_msat")]
	    pub our_funding_msat: Amount,
	    #[serde(rename = "scratch_txid")]
	...
	pub struct ListpeersPeersChannelsFunding {
	    #[deprecated]
	    #[serde(rename = "local_msat", skip_serializing_if = "Option::is_none")]
	    pub local_msat: Option<Amount>,
	    #[deprecated]
	    #[serde(rename = "remote_msat", skip_serializing_if = "Option::is_none")]
	    pub remote_msat: Option<Amount>,
	    #[serde(rename = "pushed_msat", skip_serializing_if = "Option::is_none")]
	    pub pushed_msat: Option<Amount>,
	    #[serde(rename = "local_funds_msat")]
	    pub local_funds_msat: Amount,
	    #[serde(rename = "remote_funds_msat")]
	    pub remote_funds_msat: Amount,
	    #[serde(rename = "fee_paid_msat", skip_serializing_if = "Option::is_none")]
	    pub fee_paid_msat: Option<Amount>,
	    #[serde(rename = "fee_rcvd_msat", skip_serializing_if = "Option::is_none")]
	...
	pub struct ListpeersPeersChannelsHtlcs {
	    ...
	    #[serde(rename = "payment_hash")]
	    pub payment_hash: Sha256,
	    #[serde(rename = "local_trimmed", skip_serializing_if = "Option::is_none")]
	...
	pub struct ListpeersPeersChannels {
	    ...
	    #[serde(rename = "scratch_txid", skip_serializing_if = "Option::is_none")]
	    ...
	    #[serde(rename = "funding_outnum", skip_serializing_if = "Option::is_none")]
	    pub funding_outnum: Option<u32>,
	    #[serde(rename = "initial_feerate", skip_serializing_if = "Option::is_none")]
	    pub initial_feerate: Option<String>,
	    #[serde(rename = "last_feerate", skip_serializing_if = "Option::is_none")]
	    pub last_feerate: Option<String>,
	    #[serde(rename = "next_feerate", skip_serializing_if = "Option::is_none")]
	    pub next_feerate: Option<String>,
	    #[serde(rename = "next_fee_step", skip_serializing_if = "Option::is_none")]
	    pub next_fee_step: Option<u32>,
	    #[serde(rename = "inflight", skip_serializing_if = "crate::is_none_or_empty")]
	    ...
	    #[serde(rename = "to_us_msat", skip_serializing_if = "Option::is_none")]
	    pub to_us_msat: Option<Amount>,
	    #[serde(rename = "min_to_us_msat", skip_serializing_if = "Option::is_none")]
	    pub min_to_us_msat: Option<Amount>,
	    #[serde(rename = "max_to_us_msat", skip_serializing_if = "Option::is_none")]
	    pub max_to_us_msat: Option<Amount>,
	    #[serde(rename = "total_msat", skip_serializing_if = "Option::is_none")]
	    ...
	    #[serde(rename = "dust_limit_msat", skip_serializing_if = "Option::is_none")]
	    pub dust_limit_msat: Option<Amount>,
	    #[serde(rename = "max_total_htlc_in_msat", skip_serializing_if = "Option::is_none")]
	    pub max_total_htlc_in_msat: Option<Amount>,
	    #[serde(rename = "their_reserve_msat", skip_serializing_if = "Option::is_none")]
	    pub their_reserve_msat: Option<Amount>,
	    #[serde(rename = "our_reserve_msat", skip_serializing_if = "Option::is_none")]
	    pub our_reserve_msat: Option<Amount>,
	    #[serde(rename = "spendable_msat", skip_serializing_if = "Option::is_none")]
	    pub spendable_msat: Option<Amount>,
	    #[serde(rename = "receivable_msat", skip_serializing_if = "Option::is_none")]
	    pub receivable_msat: Option<Amount>,
	    #[serde(rename = "minimum_htlc_in_msat", skip_serializing_if = "Option::is_none")]
	    pub minimum_htlc_in_msat: Option<Amount>,
	    #[serde(rename = "minimum_htlc_out_msat", skip_serializing_if = "Option::is_none")]
	    pub minimum_htlc_out_msat: Option<Amount>,
	    #[serde(rename = "maximum_htlc_out_msat", skip_serializing_if = "Option::is_none")]
	    pub maximum_htlc_out_msat: Option<Amount>,
	    #[serde(rename = "their_to_self_delay", skip_serializing_if = "Option::is_none")]
	    pub their_to_self_delay: Option<u32>,
	    #[serde(rename = "our_to_self_delay", skip_serializing_if = "Option::is_none")]
	    pub our_to_self_delay: Option<u32>,
	    #[serde(rename = "max_accepted_htlcs", skip_serializing_if = "Option::is_none")]
	    pub max_accepted_htlcs: Option<u32>,
	    #[serde(rename = "alias", skip_serializing_if = "Option::is_none")]
	    pub alias: Option<ListpeersPeersChannelsAlias>,
	    #[serde(rename = "state_changes", skip_serializing_if = "crate::is_none_or_empty")]
	    pub state_changes: Option<Vec<ListpeersPeersChannelsState_changes>>,
	    #[serde(rename = "status", skip_serializing_if = "crate::is_none_or_empty")]
	    pub status: Option<Vec<String>>,
	    #[serde(rename = "in_payments_offered", skip_serializing_if = "Option::is_none")]
	    pub in_payments_offered: Option<u64>,
	    #[serde(rename = "in_offered_msat", skip_serializing_if = "Option::is_none")]
	    pub in_offered_msat: Option<Amount>,
	    #[serde(rename = "in_payments_fulfilled", skip_serializing_if = "Option::is_none")]
	    pub in_payments_fulfilled: Option<u64>,
	    #[serde(rename = "in_fulfilled_msat", skip_serializing_if = "Option::is_none")]
	    pub in_fulfilled_msat: Option<Amount>,
	    #[serde(rename = "out_payments_offered", skip_serializing_if = "Option::is_none")]
	    pub out_payments_offered: Option<u64>,
	    #[serde(rename = "out_offered_msat", skip_serializing_if = "Option::is_none")]
	    pub out_offered_msat: Option<Amount>,
	    #[serde(rename = "out_payments_fulfilled", skip_serializing_if = "Option::is_none")]
	    pub out_payments_fulfilled: Option<u64>,
	    #[serde(rename = "out_fulfilled_msat", skip_serializing_if = "Option::is_none")]
	    pub out_fulfilled_msat: Option<Amount>,
	    #[serde(rename = "htlcs", skip_serializing_if = "crate::is_none_or_empty")]
	    pub htlcs: Option<Vec<ListpeersPeersChannelsHtlcs>>,
	    #[serde(rename = "close_to_addr", skip_serializing_if = "Option::is_none")]
	...
	pub struct ListpeersPeers {
	    ...
	    pub connected: bool,
	    #[serde(rename = "log", skip_serializing_if = "crate::is_none_or_empty")]
	    pub log: Option<Vec<ListpeersPeersLog>>,
	    #[deprecated]
	    #[serde(rename = "channels", skip_serializing_if = "crate::is_none_or_empty")]
	    pub channels: Option<Vec<ListpeersPeersChannels>>,
	    #[serde(rename = "netaddr", skip_serializing_if = "crate::is_none_or_empty")]
	    pub netaddr: Option<Vec<String>>,
	    #[serde(rename = "remote_addr", skip_serializing_if = "Option::is_none")]
	...
	pub struct ListfundsChannels {
	    ...
	    #[serde(rename = "our_amount_msat")]
	    pub our_amount_msat: Amount,
	    #[serde(rename = "amount_msat")]
	    pub amount_msat: Amount,
	    #[serde(rename = "funding_txid")]
	    pub funding_txid: String,
	    #[serde(rename = "funding_output")]
	...
	pub struct SendpayResponse {
	    ...
	    #[serde(rename = "bolt11", skip_serializing_if = "Option::is_none")]
	    pub bolt11: Option<String>,
	    #[serde(rename = "bolt12", skip_serializing_if = "Option::is_none")]
	...
	pub struct ListchannelsChannels {
	    ...
	    #[serde(rename = "destination")]
	    pub destination: PublicKey,
	    #[serde(rename = "short_channel_id")]
	    pub short_channel_id: ShortChannelId,
	    #[serde(rename = "public")]
	    pub public: bool,
	    #[serde(rename = "amount_msat")]
	    pub amount_msat: Amount,
	    #[serde(rename = "message_flags")]
	    pub message_flags: u8,
	    #[serde(rename = "channel_flags")]
	    pub channel_flags: u8,
	    #[serde(rename = "active")]
	    pub active: bool,
	    #[serde(rename = "last_update")]
	    pub last_update: u32,
	    #[serde(rename = "base_fee_millisatoshi")]
	    pub base_fee_millisatoshi: u32,
	    #[serde(rename = "fee_per_millionth")]
	    pub fee_per_millionth: u32,
	    #[serde(rename = "delay")]
	    pub delay: u32,
	    #[serde(rename = "htlc_minimum_msat")]
	    pub htlc_minimum_msat: Amount,
	    #[serde(rename = "htlc_maximum_msat", skip_serializing_if = "Option::is_none")]
	...
	pub struct CreateinvoiceResponse {
	    ...
	    pub expires_at: u64,
	    #[serde(rename = "pay_index", skip_serializing_if = "Option::is_none")]
	    pub pay_index: Option<u64>,
	    #[serde(rename = "amount_received_msat", skip_serializing_if = "Option::is_none")]
	    pub amount_received_msat: Option<Amount>,
	    #[serde(rename = "paid_at", skip_serializing_if = "Option::is_none")]
	    pub paid_at: Option<u64>,
	    #[serde(rename = "payment_preimage", skip_serializing_if = "Option::is_none")]
	    pub payment_preimage: Option<Secret>,
	    #[serde(rename = "local_offer_id", skip_serializing_if = "Option::is_none")]
	    pub local_offer_id: Option<String>,
	    #[serde(rename = "invreq_payer_note", skip_serializing_if = "Option::is_none")]
	...
	pub struct InvoiceResponse {
	    ...
	    #[serde(rename = "payment_hash")]
	    pub payment_hash: Sha256,
	    #[serde(rename = "payment_secret")]
	    pub payment_secret: Secret,
	    #[serde(rename = "expires_at")]
	    pub expires_at: u64,
	    #[serde(rename = "warning_capacity", skip_serializing_if = "Option::is_none")]
	    pub warning_capacity: Option<String>,
	    #[serde(rename = "warning_offline", skip_serializing_if = "Option::is_none")]
	    pub warning_offline: Option<String>,
	    #[serde(rename = "warning_deadends", skip_serializing_if = "Option::is_none")]
	    pub warning_deadends: Option<String>,
	    #[serde(rename = "warning_private_unused", skip_serializing_if = "Option::is_none")]
	    pub warning_private_unused: Option<String>,
	    #[serde(rename = "warning_mpp", skip_serializing_if = "Option::is_none")]
	...
	pub struct ListsendpaysPayments {
	    ...
	    #[serde(rename = "payment_preimage", skip_serializing_if = "Option::is_none")]
	    pub payment_preimage: Option<Secret>,
	    #[serde(rename = "erroronion", skip_serializing_if = "Option::is_none")]
	...
	pub struct PayResponse {
	    ...
	    #[serde(rename = "amount_sent_msat")]
	    pub amount_sent_msat: Amount,
	    #[serde(rename = "warning_partial_completion", skip_serializing_if = "Option::is_none")]
	...
	pub struct ListnodesNodes {
	    ...
	    #[serde(rename = "features", skip_serializing_if = "Option::is_none")]
	    pub features: Option<String>,
	    #[serde(rename = "addresses", skip_serializing_if = "crate::is_none_or_empty")]
	...
	pub struct FundpsbtReservations {
	    ...
	    #[serde(rename = "vout")]
	    pub vout: u32,
	    #[serde(rename = "was_reserved")]
	    pub was_reserved: bool,
	    #[serde(rename = "reserved")]
	    pub reserved: bool,
	    #[serde(rename = "reserved_to_block")]
	...
	pub struct FundpsbtResponse {
	    #[serde(rename = "psbt")]
	    pub psbt: String,
	    #[serde(rename = "feerate_per_kw")]
	    pub feerate_per_kw: u32,
	    #[serde(rename = "estimated_final_weight")]
	    pub estimated_final_weight: u32,
	    #[serde(rename = "excess_msat")]
	    pub excess_msat: Amount,
	    #[serde(rename = "change_outnum", skip_serializing_if = "Option::is_none")]
	    pub change_outnum: Option<u32>,
	    #[serde(rename = "reservations", skip_serializing_if = "crate::is_none_or_empty")]
	...
	pub struct FeeratesPerkb {
	    #[serde(rename = "min_acceptable")]
	    pub min_acceptable: u32,
	    #[serde(rename = "max_acceptable")]
	    pub max_acceptable: u32,
	    #[serde(rename = "opening", skip_serializing_if = "Option::is_none")]
	    pub opening: Option<u32>,
	    #[serde(rename = "mutual_close", skip_serializing_if = "Option::is_none")]
	    pub mutual_close: Option<u32>,
	    #[serde(rename = "unilateral_close", skip_serializing_if = "Option::is_none")]
	    pub unilateral_close: Option<u32>,
	    #[serde(rename = "delayed_to_us", skip_serializing_if = "Option::is_none")]
	    pub delayed_to_us: Option<u32>,
	    #[serde(rename = "htlc_resolution", skip_serializing_if = "Option::is_none")]
	...
	pub struct FeeratesOnchain_fee_estimates {
	    #[serde(rename = "opening_channel_satoshis")]
	    pub opening_channel_satoshis: u64,
	    #[serde(rename = "mutual_close_satoshis")]
	    pub mutual_close_satoshis: u64,
	    #[serde(rename = "unilateral_close_satoshis")]
	    pub unilateral_close_satoshis: u64,
	    #[serde(rename = "htlc_timeout_satoshis")]
	    pub htlc_timeout_satoshis: u64,
	    #[serde(rename = "htlc_success_satoshis")]
	    pub htlc_success_satoshis: u64,
	}

	#[derive(Clone, Debug, Deserialize, Serialize)]
	pub struct FeeratesResponse {
	    #[serde(rename = "warning_missing_feerates", skip_serializing_if = "Option::is_none")]
	    pub warning_missing_feerates: Option<String>,
	    #[serde(rename = "perkb", skip_serializing_if = "Option::is_none")]
	    pub perkb: Option<FeeratesPerkb>,
	    #[serde(rename = "perkw", skip_serializing_if = "Option::is_none")]
	    pub perkw: Option<FeeratesPerkw>,
	    #[serde(rename = "onchain_fee_estimates", skip_serializing_if = "Option::is_none")]
	...
	pub struct ListforwardsForwards {
	    ...
	    #[serde(rename = "in_htlc_id", skip_serializing_if = "Option::is_none")]
	    pub in_htlc_id: Option<u64>,
	    #[serde(rename = "in_msat")]
	    pub in_msat: Amount,
	    ...
	    #[serde(rename = "out_channel", skip_serializing_if = "Option::is_none")]
	    pub out_channel: Option<ShortChannelId>,
	    #[serde(rename = "out_htlc_id", skip_serializing_if = "Option::is_none")]
	    pub out_htlc_id: Option<u64>,
	    #[serde(skip_serializing_if = "Option::is_none")]
	    pub style: Option<ListforwardsForwardsStyle>,
	    #[serde(rename = "fee_msat", skip_serializing_if = "Option::is_none")]
	    pub fee_msat: Option<Amount>,
	    #[serde(rename = "out_msat", skip_serializing_if = "Option::is_none")]
	...
	pub struct ListpaysPays {
	    ...
	    #[serde(rename = "preimage", skip_serializing_if = "Option::is_none")]
	    pub preimage: Option<String>,
	    #[serde(rename = "number_of_parts", skip_serializing_if = "Option::is_none")]
	...
	pub struct SetchannelChannels {
	    ...
	    #[serde(rename = "short_channel_id", skip_serializing_if = "Option::is_none")]
	    pub short_channel_id: Option<ShortChannelId>,
	    #[serde(rename = "fee_base_msat")]
	    pub fee_base_msat: Amount,
	    #[serde(rename = "fee_proportional_millionths")]
	    pub fee_proportional_millionths: u32,
	    #[serde(rename = "minimum_htlc_out_msat")]
	    pub minimum_htlc_out_msat: Amount,
	    #[serde(rename = "warning_htlcmin_too_low", skip_serializing_if = "Option::is_none")]
	    pub warning_htlcmin_too_low: Option<String>,
	    #[serde(rename = "maximum_htlc_out_msat")]
	    pub maximum_htlc_out_msat: Amount,
	    #[serde(rename = "warning_htlcmax_too_high", skip_serializing_if = "Option::is_none")]
